...
import beam.playground.ajdeqsim.v1.messages.EndLegMessage;
import beam.playground.ajdeqsim.v1.messages.EndRoadMessage;
import beam.playground.ajdeqsim.v1.messages.EnterRoadMessage;
import beam.playground.ajdeqsim.v1.messages.LeaveRoadMessage;
import beam.playground.ajdeqsim.v1.messages.StartingLegMessage;
...
public class Vehicle extends SimUnit {
	...
	public void scheduleEndRoadMessage(double scheduleTime, Road road) {
		sendMessage(new EndRoadMessage(scheduler, this), road, scheduleTime);
	}

	public void scheduleLeaveRoadMessage(double scheduleTime, Road road) {
		sendMessage(new LeaveRoadMessage(scheduler, this), road, scheduleTime);
	}

	public void scheduleEndLegMessage(double scheduleTime, Road road) {
		sendMessage(new EndLegMessage(scheduler, this), road, scheduleTime);
	}

	public void scheduleStartingLegMessage(double scheduleTime, Road road) {
		sendMessage(new StartingLegMessage(scheduler, this), road, scheduleTime);
	}

	public DeadlockPreventionMessage scheduleDeadlockPreventionMessage(double scheduleTime, Road road) {
		DeadlockPreventionMessage dpMessage = new DeadlockPreventionMessage(scheduler, this);
