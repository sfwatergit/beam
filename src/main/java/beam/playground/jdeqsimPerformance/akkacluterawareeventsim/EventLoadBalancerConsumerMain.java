...
import beam.playground.jdeqsimPerformance.akkacluterawareeventsim.loadbalancer.EventCollectorActor;
import beam.playground.jdeqsimPerformance.akkacluterawareeventsim.loadbalancer.EventConsumerLoadBalancer;
 ...
 */
public class EventLoadBalancerConsumerMain {
    private LoggingAdapter log = null;
    private ActorSystem system;
    private ActorRef eventLoadBalancerActor;
    private ActorRef eventManagerActor;
    private ActorRef eventCollectorActor;
     ...
     * Default Constructor
	 */
    public EventLoadBalancerConsumerMain() {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        EventLoadBalancerConsumerMain eCM = new EventLoadBalancerConsumerMain();
    ...
    public void setupLocalAndRemoteActor() {
        ...
        eventCollectorActor = system.actorOf(Props.create(EventCollectorActor.class, eventManagerActor), "EventCollectorActor");
        eventLoadBalancerActor = system.actorOf(Props.create(EventConsumerLoadBalancer.class, eventCollectorActor), "EventBufferActor");
        remoteEventGeneratorActor = system.actorOf(Props.create(RealTimeEventGenerator.class, eventLoadBalancerActor), "remoteEventGeneratorActor");
