...
public class task3Main {
    private static final Logger log = Logger.getLogger(task3Main.class);
    ...
    public static void main(String[] args) {
        ...
        generateActorRef.tell(new GenerateActorMessage(100000000, GenerateEventMessage.LINK_ENTER_EVENT), ActorRef.noSender());
